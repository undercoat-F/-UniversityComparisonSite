...
# -*- coding: utf-8 -*-
"""
test_seed_observer.py
seed_observer モジュールのユニットテスト
- extract_universitynamelist(): 英日両対応の大学名抽出
ネット通信なし・DB不要。
"""
...
from crawler.seed_observer import extract_universitynamelist


def make_page(candidate_lines: list) -> PageAnalysis:
    page = PageAnalysis()
...
class TestExtractUniversityNamelistMixed(unittest.TestCase):
    ...
    def test_result_stored_on_page(self):
        """戻り値と PageAnalysis.extracted_universitynamelist が一致する"""
